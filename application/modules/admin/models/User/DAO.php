...
class Admin_Model_User_DAO implements Zf_Model_IDAO, Login_Model_User_IDAO
{
	/**
	 * @var Login_Model_DbTable_User
	 */
	protected $_dbTable;
	
	/**
	 * @param string|Login_Model_DbTable_User $dbTable
	 * @return Login_Model_User_DAO
	 * @throws Login_Model_User_Exception
	 */
	public function setDbTable($dbTable) {
        ...
        if (!$dbTable instanceof Zend_Db_Table_Abstract) {
            throw new Login_Model_User_Exception('Invalid table data gateway provided');
        }
	...
	public function getDbTable() {
		if (null === $this->_dbTable) {
            $this->setDbTable('Login_Model_DbTable_User');
        }
